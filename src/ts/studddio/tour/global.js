...
var globalMaterial = new THREE.MeshFaceMaterial([
   new THREE.MeshPhongMaterial({color: 0xffffff, shading: THREE.FlatShading}), // front
   new THREE.MeshPhongMaterial({color: 0xffffff, shading: THREE.SmoothShading}) // side
]);

var globalWhiteMaterial = new THREE.MeshFaceMaterial([
   new THREE.MeshPhongMaterial({color: 0xffffff, shading: THREE.FlatShading}), // front
   new THREE.MeshPhongMaterial({color: 0xffffff, shading: THREE.SmoothShading}) // side
]);

var globalBlackMaterial = new THREE.MeshFaceMaterial([
...
var globalRedMaterial = new THREE.MeshFaceMaterial([
...
var globalGreenMaterial = new THREE.MeshFaceMaterial([
...
var globalBlueMaterial = new THREE.MeshFaceMaterial([
...
var globalYellowMaterial = new THREE.MeshFaceMaterial([
...
var globalOrangeMaterial = new THREE.MeshFaceMaterial([
   new THREE.MeshPhongMaterial({color: 0xffa500, shading: THREE.FlatShading}), // front
   new THREE.MeshPhongMaterial({color: 0xffa500, shading: THREE.SmoothShading}) // side
]);
